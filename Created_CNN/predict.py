...
wb=xlsxwriter.Workbook('Conf_Matrix_LRm.xlsx')
ws=wb.add_worksheet()
...
for clase in classes:
	...
	for filename in glob.glob(dir_path +'/*.jpg'):
		...
		saver = tf.train.import_meta_graph('keys-wallet-LR_m-model.meta')
		...
		r1=str(result[0,0]*100)
		r2=str(result[0,1]*100)

		rs=(result[0,0]*10**12,result[0,1]*10**12)
		max_=max(rs)
		...
		ws.write(r_acc,col,rs[max_class]/(10**12))
